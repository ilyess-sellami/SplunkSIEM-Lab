...
**🛡️ Hands-on SIEM Lab With Splunk Entreprise & Universal Forwarders**

---

![Splunk SIEM Lab](/docs/github_banner_image.png)

---

## 📌 Overview 

**Splunk SIEM Lab** is a **hands-on lab** environment for learning, testing, and showcasing **Splunk** as a **Security Information and Event Management (SIEM)** solution.  
